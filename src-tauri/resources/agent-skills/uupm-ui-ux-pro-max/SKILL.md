...
```json
{ "tool": "skill.run_script", "args": { "skill": "uupm-ui-ux-pro-max",
  "script": "core.py", "args": ["<first argument>", "--flag", "<value>"] } }
```
...
Read `references/search-tips.md` before your first search in a session: it
covers query wording, combining domains, and what to do with weak matches.
