...
pub fn strip_windows_drive_slash(s: &str) -> Option<&str> {
    let b = s.as_bytes();
    (b.len() >= 3
        && (b[0] == b'/' || b[0] == b'\\')
...
/// Removes `file://` authority prefix or `file:` scheme prefix from file paths,
/// and strips redundant leading slashes before Windows drive letters on Windows.
pub fn normalize_file_path(path: &str) -> String {
    ...
    #[cfg(windows)]
    if let Some(rest) = strip_windows_drive_slash(stripped) {
...
mod tests {
    ...
    fn test_strip_windows_drive_slash() {
        assert_eq!(
            strip_windows_drive_slash(r"/C:\Users\User\Documents\file.md"),
            Some(r"C:\Users\User\Documents\file.md")
        );
        assert_eq!(
            strip_windows_drive_slash(r"\D:\data\models"),
            Some(r"D:\data\models")
        );
        assert_eq!(
            strip_windows_drive_slash("/C:/Users/User/Documents/file.md"),
            Some("C:/Users/User/Documents/file.md")
        );
        assert_eq!(strip_windows_drive_slash("/home/user/file.md"), None);
        assert_eq!(strip_windows_drive_slash("/c:notes"), None);
    }

    #[cfg(windows)]
    #[test]
    fn test_normalize_file_path_strips_redundant_leading_slash_on_windows_drives() {
        assert_eq!(
            normalize_file_path(r"/C:\Users\User\Documents\file.md"),
            r"C:\Users\User\Documents\file.md"
        );
        assert_eq!(normalize_file_path(r"\D:\data\models"), r"D:\data\models");
        assert_eq!(
            normalize_file_path("file:/C:/Users/User/Documents/file.md"),
    ...
    #[test]
    fn test_normalize_file_path_preserves_posix_paths() {
        assert_eq!(
            normalize_file_path("/home/user/file.md"),
            "/home/user/file.md"
        );
        assert_eq!(
            normalize_file_path("/home/user/profile:/draft.md"),
            "/home/user/profile:/draft.md"
        );
        assert_eq!(
            normalize_file_path("file:///home/user/file.md"),
            "/home/user/file.md"
        );
        assert_eq!(normalize_file_path("/c:notes"), "/c:notes");
    }
}
