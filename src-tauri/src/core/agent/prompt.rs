...
pub const ITERATION_ONE_TOOLS: &[ToolDescriptor] = &[
    ...
    ToolDescriptor {
        name: "os.fs.grep",
        summary: "Search file contents with a regex using ripgrep from PATH. Read-only.",
    ...
    ToolDescriptor {
        name: "os.fs.patch",
        summary: "Check or apply a unified diff with the system patch utility (dry-run by default). Approval-gated.",
