  ...
  },
  {
    ...
    editor: {
      ...
      steps: [
        ...
        'Select the Radium model from the model picker to start chatting.',
      ],
    },
  },
  {
    ...
    editor: {
      ...
      steps: [
        ...
        'Select the Radium model as the provider for AI Assistant.',
      ],
    },
  },
  {
    ...
    editor: {
      ...
      steps: [
        ...
        'Restart Xcode if the models do not appear, then pick the Radium model.',
      ],
    },
  },
]
