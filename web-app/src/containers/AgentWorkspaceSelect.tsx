...
export function AgentWorkspaceSelect({
  ...
  return (
    <button
      type="button"
      className="flex max-w-48 items-center gap-1 rounded-md px-1.5 py-0.5 text-[11px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
